...
| ID         | 항목                     | 상세 설명                                                                                                                                | 페이지                       |
| :--------- | :----------------------- | :--------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------- |
| **FE-601** | 콘텐츠 기반 애니 추천    | - 관심 애니 기반 사용자 맞춤형 애니 추천<br>- 추천 결과 캐싱 및 관심 애니 변경 시 자동 갱신 | 마이페이지 > 관심 애니메이션 |
| **FE-602** | 추천 애니 기반 굿즈 추천 | - 추천 애니 연관 굿즈 추천<br>- 본인 판매 굿즈, 이미 찜한 굿즈 제외<br>- 경매 대기·진행 중인 굿즈만 필터링                               | 메인페이지                   |
